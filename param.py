...
parser.add_argument('--train_radio', type=float, default=0.6, help='Train radio')
parser.add_argument('--vali_radio', type=float, default=0.2, help='Validation radio')
parser.add_argument('--test_radio', type=float, default=0.2, help='Test radio')

# args for model
parser.add_argument('--input_dim', type=int, default=60, help='Input dimension')
